...
<div class="container-fluid" id="introdiv-edit">
    ...
    <form action="{{route('backend.about.introdiv.update',$introdiv->id)}}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-8 ">
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <input type="text" name="title" class="form-control" value="{{$introdiv->title}}" placeholder="title">
                    </div>
                </div>
                <div class="card mb-3">
                    <div class="card-body">
