  ...
  <div class="container-fluid" id="navbar-container">
    ...
    <div class="collapse navbar-collapse vertical " id="navbarResponsive">
      ...
      <ul class="nav navbar-nav flex-column mr-auto" id="mainNav">
        ...
        <li class="nav-item">
          <a class="nav-link text-uppercase font-weight-bold" id="news-text" href="#"><img src="img/icon/news_icon.png"><span class="align-middle"> 最新消息</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-uppercase font-weight-bold" id="products-text" href="#"><img src="img/icon/products_icon.png"><span class="align-middle"> 商品介紹</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-uppercase font-weight-bold" id="shop-text" href="#"><img src="img/icon/shop_icon.png"><span class="align-middle"> 店鋪消息</span></a>
        </li>
        <li class="nav-item">
